...
def make_dalle_req(client, subject, style, model="dall-e-2"):
    prompt = (
        f"Subject: {subject}. "  # use space at the end for implicit line continuation
        f"Style: {style}. "
    )
    ...
    if image_objects:
        ...
        for i, img in enumerate(image_objects):
            ...
            # IF WANTING TO DISPLAY IMAGE IN NEW WINDOW
